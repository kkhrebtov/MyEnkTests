...
namespace TestMailStreamers
    ...
    class ExchangeStreamerTest
        ...
        public class TestOutcomingOutlookMessages
            ...
            [Values("account_2_alias@enkata.com")] String fromAddress,
            [Values("enk.lead1@gmail.com")] String toAddress)
                ...
                SqlDataValidator.CheckMailResults(sqlConnectionString, "account_2@enkata.com", fromAddress, toAddresses, null, null, expSubj, expConvId, attDisplayNames, "Email Sent");
            ...
            [Values("enk.lead1@gmail.com")] String toAddress)
                ...
                SqlDataValidator.CheckMailResults(sqlConnectionString, "account_1@enkata.com", fromAddress, toAddresses, null, null, expSubj, expConvId, attDisplayNames, "Email Sent");
            ...
            [Values("enk.lead2@gmail.com")] String ccAddress)
                ...
                SqlDataValidator.CheckMailResults(sqlConnectionString, "account_1@enkata.com", fromAddress, toAddresses, ccAddresses, null, expSubj, expConvId, attDisplayNames, "Email Sent");
            ...
            [Test]
            public void SendMailOutlook_RecipentsToBcc(
            [Values("account_1@enkata.com")] String fromAddress,
            [Values("enk.lead1@gmail.com")] String toAddress,
            [Values("enk.lead2@gmail.com")] String bccAddress)
                ...
                SqlDataValidator.CheckMailResults(sqlConnectionString, "account_1@enkata.com", fromAddress, toAddresses, null, bccAddresses, expSubj, expConvId, attDisplayNames, "Email Sent");
            ...
            [Test]
            public void SendMailOutlook_OnlyBcc(
            [Values("account_1@enkata.com")] String fromAddress,
            [Values("enk.lead1@gmail.com")] String toAddress)
                {
                ...
                Outlook._MailItem mail = EMailPrepare.CreateOutlookEmail(fromAddress, null, null, toAddresses, attDisplayNames, attSource);
                ...
                SqlDataValidator.CheckMailResults(sqlConnectionString, "account_1@enkata.com", fromAddress, null, null, toAddresses, expSubj, expConvId, attDisplayNames, "Email Sent");

                String[] expectedScrapes = { "Bcc", "Mailbox", "Subject", "ConversationId", "ConversationTopic", "Id" };
        ...
        public class TestIncomingOutlookMessages
            ...
            [Test]
            public void SendMailOutlook_MultipleRecipentsTo(
            [Values("account_2_alias@enkata.com")] String toAddress,
            [Values("kkhrebtov@enkata.com")] String fromAddress
                ...
                SqlDataValidator.CheckMailResults(sqlConnectionString, "account_2@enkata.com", fromAddress, toAddresses, null, null, expSubj, expConvId, attDisplayNames, "Email Received");
            ...
            public void SendMailOutlook_SinglePersonInCc(
                ...
                [Values("account_2_alias@enkata.com")] String ccAddress,
                [Values("kkhrebtov@enkata.com")] String fromAddress)
                {
                ...
                SqlDataValidator.CheckMailResults(sqlConnectionString, "account_2@enkata.com", fromAddress, toAddresses, ccAddresses, null, expSubj, expConvId, attDisplayNames, "Email Received");
                String[] expectedScrapes = { "To", "Cc", "Mailbox", "Subject", "ConversationId", "ConversationTopic", "Id" };
            ...
            [Test]
            public void SendMailOutlook_OnlySinglePersonInBcc(
                [Values("account_2_alias@enkata.com")] String bccAddress,
                [Values("kkhrebtov@enkata.com")] String fromAddress)
                {

                bccAddresses.Add(bccAddress);

                Outlook._MailItem mail = EMailPrepare.CreateOutlookEmail(fromAddress, null, null, bccAddresses, attDisplayNames, attSource);
                ...
                SqlDataValidator.CheckMailResults(sqlConnectionString, "account_2@enkata.com", fromAddress, null, null, null, expSubj, expConvId, attDisplayNames, "Email Received");

                String[] expectedScrapes = { "Mailbox", "Subject", "ConversationId", "ConversationTopic", "Id" };
            ...
            public void SendMailOutlook_EmptyTo_Bcc(
                ...
                SqlDataValidator.CheckMailResults(sqlConnectionString, "account_2@enkata.com", fromAddress, null, ccAddresses, null, expSubj, expConvId, attDisplayNames, "Email Received");

                String[] expectedScrapes = { "Cc", "Mailbox", "Subject", "ConversationId", "ConversationTopic", "Id" };
            ...
            [Test]
            public void SendMailOutlook_EmptySubject2(

                [Values("account_2_alias@enkata.com")] String fromAddress,
                [Values("enk.lead2@gmail.com")] String ccAddress,
                [Values("kkhrebtov@enkata.com")] String toAddress)
                {
                ...
                SqlDataValidator.CheckMailResults(sqlConnectionString, fromAddress, fromAddress, toAddresses, ccAddresses, null, expSubj, expConvId, attDisplayNames, "Email Sent");
            ...
            public void IncomingEmailWithSingleTo(
                ...
                SqlDataValidator.CheckMailResults(sqlConnectionString, "account_2@enkata.com", fromAddress, toAddresses, null, null, subject, null, null, "Email Received");
            ...
            public void IncomingEmailWithSingleToCcBcc_To(
                ...
                SqlDataValidator.CheckMailResults(sqlConnectionString, "account_2@enkata.com", fromAddress, toAddresses, ccAddresses, null, subject, null, null, "Email Received");
        ...
        public class TestCalendarEvents
            ...
            public void SendMeetingToSingleRecipient(
                [Values("kkhrebtov@enkata.com")] String fromAddress,
                [Values("account_1_alias@enkata.com")] String requiredAttendy)
                {
                ...
                String expiCalUid = AppointmentManagement.SendOutlookAppointment(fromAddress, "10/10/2015 10:10:00 AM", 0.1f, requiredAttendies, null, subj, body, attDisplayNames, attSource);

                Thread.Sleep(timeout);

                SqlDataValidator.CheckMeetingOutlookResults(sqlConnectionString, "account_1@enkata.com", fromAddress, requiredAttendies, null, subj, expiCalUid, 360, null, "Appointment Updated");
            ...
            public void SendMeetingToReqAndOptAttendees(
                ...
                [Values("account_1_alias@enkata.com")] String optionalAttendy)
                {
                ...
                String expiCalUid = AppointmentManagement.SendOutlookAppointment(fromAddress, "10/10/2015 10:10:00 AM", 0.1f, requiredAttendies, optionalAttendies, subj, body, attDisplayNames, attSource);
                Thread.Sleep(timeout);

                SqlDataValidator.CheckMeetingOutlookResults(sqlConnectionString, "account_1@enkata.com", fromAddress, requiredAttendies, optionalAttendies, subj, expiCalUid, 360, null, "Appointment Updated");
            ...
            public void SendMeetingOnlyOptAttendees(
                ...
                String expiCalUid = AppointmentManagement.SendOutlookAppointment(fromAddress, "10/10/2015 10:10:00 AM", 0.1f, null, optionalAttendies, subj, body, attDisplayNames, attSource);
            ...
            public void SendMeetingUpdate(
                ...
                //SqlDataValidator.CheckMeetingOutlookResults(sqlConnectionString, "account_1@enkata.com", fromAddress, requiredAttendies, null, subj, expiCalUid, 3600, null);
            ...
            public void SendMeetingWithEmptySubject(
                ...
                String expiCalUid = AppointmentManagement.SendOutlookAppointment(fromAddress, "10/10/2015 10:10:00 AM", 0.1f, requiredAttendies, null, null, body, attDisplayNames, attSource);

                Thread.Sleep(timeout);

                SqlDataValidator.CheckMeetingOutlookResults(sqlConnectionString, "account_1@enkata.com", fromAddress, requiredAttendies, null, "", expiCalUid, 360, null, "Appointment Updated");
            ...
            public void SendFullDayEventWithSingleRecipient(
                ...
                SqlDataValidator.CheckMeetingOutlookResults(sqlConnectionString, "account_1@enkata.com", fromAddress, requiredAttendies, null, subj, expiCalUid, 86400, null, "Appointment Updated");
